...
var ERR_INVALID_METHOD = _nanoerror2.default.call(void 0, 
  "HPE_INVALID_METHOD",
  "Invalid method encountered"
);
var ERR_HEAD_SET = _nanoerror2.default.call(void 0, 
  "ERR_HEAD_SET",
  "Cannot set headers after they are sent to the client"
);
var ERR_ADDRINUSE = _nanoerror2.default.call(void 0, 
  "EADDRINUSE",
  "listen EADDRINUSE: address already in use %s:%s"
);
var ERR_UPGRADE = _nanoerror2.default.call(void 0, 
  "ERR_UPGRADE",
  "Cannot upgrade to WebSocket protocol %o"
);
var ERR_STREAM_DESTROYED = _nanoerror2.default.call(void 0, 
  "ERR_STREAM_DESTROYED",
  "Stream destroyed"
);
var ERR_UWS_APP_NOT_FOUND = _nanoerror2.default.call(void 0, 
  "ERR_UWS_APP_NOT_FOUND",
  "uWebSockets app not found"
);
var ERR_ENOTFOUND = _nanoerror2.default.call(void 0, 
  "ERR_ENOTFOUND",
  "getaddrinfo ENOTFOUND %s"
);
var ERR_SOCKET_BAD_PORT = _nanoerror2.default.call(void 0, 
  "ERR_SOCKET_BAD_PORT",
  "RangeError [ERR_SOCKET_BAD_PORT]: options.port should be >= 0 and < 65536. Received (%s)"
);
var ERR_SERVER_DESTROYED = _nanoerror2.default.call(void 0, 
...
var localAddressIpv6 = Buffer.from([
  0,
  0,
  0,
  0,
...
var toHex = (buf, start, end) => buf.slice(start, end).toString("hex");
var noop = () => {
};
function onAbort() {
  this.aborted = true;
...
function byteLength(data) {
  if (_optionalChain([data, 'optionalAccess', _2 => _2.empty]))
    return 0;
  if (_optionalChain([data, 'optionalAccess', _3 => _3.byteLength]) !== void 0)
    return data.byteLength;
  return Buffer.byteLength(data);
}
function getChunk(data) {
  if (_optionalChain([data, 'optionalAccess', _4 => _4.chunk]))
    return data.chunk;
  return data;
}
var HTTPSocket = class extends _eventemitter3.EventEmitter {
...
var Response = class extends _streamx.Writable {
  ...
  getHeader(name) {
    return _optionalChain([this, 'access', _5 => _5[kHeaders], 'access', _6 => _6.get, 'call', _7 => _7(name.toLowerCase()), 'optionalAccess', _8 => _8.value]);
  }
  getHeaders() {
    const headers = {};
...
var WebSocket = class _WebSocket extends _eventemitter3.EventEmitter {
  /**
...
var WebSocketServer = class extends _eventemitter3.EventEmitter {
  /**
...
exports.ERR_INVALID_METHOD = ERR_INVALID_METHOD; exports.ERR_ADDRINUSE = ERR_ADDRINUSE; exports.ERR_UWS_APP_NOT_FOUND = ERR_UWS_APP_NOT_FOUND; exports.ERR_ENOTFOUND = ERR_ENOTFOUND; exports.ERR_SOCKET_BAD_PORT = ERR_SOCKET_BAD_PORT; exports.ERR_SERVER_DESTROYED = ERR_SERVER_DESTROYED; exports.kHttps = kHttps; exports.kRes = kRes; exports.kAddress = kAddress; exports.kHandler = kHandler; exports.kListenSocket = kListenSocket; exports.kListen = kListen; exports.kApp = kApp; exports.kClosed = kClosed; exports.kWs = kWs; exports.kListenAll = kListenAll; exports.kListening = kListening; exports.kClientError = kClientError; exports.HTTPSocket = HTTPSocket; exports.Request = Request; exports.Response = Response; exports.WebSocket = WebSocket; exports.WebSocketStream = WebSocketStream; exports.WebSocketServer = WebSocketServer;
